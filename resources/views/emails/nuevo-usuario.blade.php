            ...
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td style="color: #343434; font-size: 24px; font-family: Open Sans, sans-serif; letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                               <h3 style="color:#1ED5F4; text-align:center;">¡ESTAMOS CERCA DE NUESTRO EVENTO! <br></h3>
                               <br>
                               <h3 style="color:#1ED5F4;">¿YA INSTALASTE EL METAVERSO?</h3>
                            </div>
                            <br>
                            <div style="line-height: 35px">
                    ...
                    <tr>
                        ...
                        Fecha: 30 de Junio <br>
                        Hora: 6 PM <br>
                        Tema: Nuevas Culturas de Trabajo<br><br>
